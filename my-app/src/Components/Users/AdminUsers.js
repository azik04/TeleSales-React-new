...
const User = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const res = await axios.get('https://localhost:7108/api/Admin/User/Admin');
        console.log(res)
  ...
  return (
    <>
      <div className="content__table">
        <div className="table__header">
          ...
          <div className="table__actions">
            <button className="table__action table__action--create" onClick={handleCreate}>
        ...
        <div className="table__types">
          {/* You can add additional filter options here if necessary */}
        </div>
      ...
      {showCreatePopup && <CreateUser close={() => setShowCreatePopup(false)}/>}
