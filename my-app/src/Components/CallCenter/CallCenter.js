...
import RemoveCall from './RemoveCallCenter';
...
const CallCenter = () => {
  ...
  useEffect(() => {
    const fetchData = async (pageNumber, pageSize) => {
      try {
        const response = await axios.get(`https://localhost:7108/api/CallCenter/Kanal/${channelId}?pageNumber=${pageNumber}&pageSize=${pageSize}`);
    ...
    <div className="content__table">
      <div className="table__header">
        ...
        <div className="table__actions">
          ...
          <button className="table__action table__action--create" onClick={() => setShowHesabatCall(true)}>
      ...
      <table className="table">
        <thead className="table__head">
          <tr className="table__row">
            ...
            <th className="table__cell">Application Type</th>
            <th className="table__cell">Region</th>
            <th className="table__cell">Phone</th>
            <th className="table__cell">Short Content</th>
            <th className="table__cell">Excluded By Name</th>
