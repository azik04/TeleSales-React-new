...
const GetByIdDetails = ({ close, callId }) => {
    ...
    return (
        <section className="popup-overlay">
            <div className="popup-container">
                ...
                <div className="input-group">
                    <div className="input-half">
                        <label htmlFor="address">Netice</label>
                        <input type="text" disabled id="address" value={data.conclusion}/>
                    </div>
                    <div className="input-half">
                        <label htmlFor="address">Icraci</label>
                ...
                <div className="input-group">
                    <div className="input-half">
                        <label htmlFor="address">Qeyd</label>
                        <textarea value={data.note} disabled></textarea>
                    </div>
                </div>
